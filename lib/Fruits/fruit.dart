...
class FruitCategories extends StatefulWidget {
  const FruitCategories({super.key});

  @override
  State<FruitCategories> createState() => _FruitCategoriesState();
}

class _FruitCategoriesState extends State<FruitCategories>
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: TabBarView(
          controller: _controller,
          children: const [TAB1(), DessertProducts(), Tab3()],
        ),
      ),
    );
  }
