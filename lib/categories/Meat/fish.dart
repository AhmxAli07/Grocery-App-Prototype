...
class _FState extends State<F> {
  final fi = FirebaseFirestore.instance.collection('Fish');
            ...
            child: Column(
              children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          fontSize: 25,
                          fontWeight: FontWeight.w700,
                          color: Color.fromARGB(255, 214, 146, 110),
                        ),
                      ),
                    ),
                  ],
                ...
                const Padding(
                  ...
                  child: Text(
                    'Fish are aquatic vertebrate animals that have gills but lack limbs with digits, like fingers or toes. Recall that vertebrates are animals with internal backbones. Most fish are streamlined in their general body form. The word fish is the same whether it is singular or pluralâ€”you can talk about one fish or ten fish.',
                    style: TextStyle(
                      fontSize: 24,
