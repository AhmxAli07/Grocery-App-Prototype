...
class MeatCategories extends StatefulWidget {
  const MeatCategories({super.key});

  @override
  State<MeatCategories> createState() => _MeatCategoriesState();
}

class _MeatCategoriesState extends State<MeatCategories>
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: TabBarView(
          controller: _controller,
          children: const [Tab3(), DessertProducts(), TAB1()],
        ),
      ),
    );
  }
